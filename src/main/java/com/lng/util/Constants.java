...
//	系统配置管理
	...
	public static final String CHECK_YC = "checkYc";//审核液厂
	...
	public static final String CHECK_QZ = "checkQz";//审核司机求职
	
	public static final String ADD_ZP = "addZp";//添加司机招聘
	public static final String UP_ZP1 = "upZp";//修改司机招聘
	public static final String CHECK_ZP = "checkZp";//审核司机招聘
	...
	public static final String CHECK_GAS_TRADE = "checkGasTrade";//修改燃气买卖
	
	public static final String CHECK_GAS_FCY_CPY_APPLY = "goCpyJoinFcyCheckPage";//贸易商加入液厂的申请审核
	public static final String CHECK_CPY_APPLY = "gomCompPage";//审核公司信息
